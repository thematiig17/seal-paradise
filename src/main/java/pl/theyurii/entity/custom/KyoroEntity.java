...
public class KyoroEntity extends AnimalEntity {
    ...
    public KyoroEntity(EntityType<? extends AnimalEntity> entityType, World world) {
    ...
    public static DefaultAttributeContainer.Builder createKyoroAttributes() {
    ...
    public @Nullable PassiveEntity createChild(ServerWorld world, PassiveEntity entity) {
        return ModEntities.KYORO.create(world);
    }

    public static boolean canSpawn(EntityType<KyoroEntity> type, ServerWorldAccess world, SpawnReason spawnReason, BlockPos pos, Random random) {
        return world.getBlockState(pos.down()).isSolidBlock(world, pos.down()) && world.getLightLevel(pos) > 0;
    }
}
